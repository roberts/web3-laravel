...
it('fires preparing/prepared or failed events for ton during staging', function () {
    Event::fake();

    $wallet = Wallet::createForProtocol(BlockchainProtocol::TON);
...
it('submits or fails ton tx broadcast and emits an event', function () {
    Event::fake();
