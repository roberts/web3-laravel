...
it('fires preparing/prepared or failed events for hedera during staging', function () {
    Event::fake();

    $wallet = Wallet::createForProtocol(BlockchainProtocol::HEDERA);
...
it('submits or fails hedera tx broadcast and emits an event', function () {
    Event::fake();
