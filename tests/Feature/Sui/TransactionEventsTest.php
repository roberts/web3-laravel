...
it('fires preparing/prepared or failed events for sui during staging', function () {
    Event::fake();

    $wallet = Wallet::createForProtocol(BlockchainProtocol::SUI);
...
it('submits or fails sui tx broadcast and emits an event', function () {
    Event::fake();
