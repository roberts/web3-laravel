...
it('fires preparing/prepared or failed events for xrpl during staging', function () {
    Event::fake();

    $wallet = Wallet::createForProtocol(BlockchainProtocol::XRPL);
...
it('submits or fails xrpl tx broadcast and emits an event', function () {
    Event::fake();
