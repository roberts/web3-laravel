...
{
    public function protocol(): BlockchainProtocol { return BlockchainProtocol::HEDERA; }
    ...
    public function validateAddress(string $address): bool { return (bool) preg_match('/^\d+\.\d+\.\d+$/', $address); }
